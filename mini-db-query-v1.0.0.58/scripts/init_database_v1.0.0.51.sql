...
-- ============================================
-- Table: query_logs (查询日志表) - v1.0.0.51 含 error_detail
-- ============================================
CREATE TABLE IF NOT EXISTS `query_logs` (
    ...
    `error_detail` JSON COMMENT '错误详情: 包含error_type, error_message, sql, suggestion',
...
-- 账号: admin  密码: 123456
-- ============================================
INSERT INTO `users` (`phone`, `password`, `name`, `id_card`, `openid`, `unionid`, `avatar`, `role`, `status`) VALUES
('admin', '$2b$12$Mq9a.Kr7A/GbTpFc6evrZuik5Uy.jPZ3nKfn08as1NDWpJ4qBrIUi', '超级管理员', NULL, NULL, NULL, NULL, 'admin', 'active'),
('13800138000', '$2b$12$Mq9a.Kr7A/GbTpFc6evrZuik5Uy.jPZ3nKfn08as1NDWpJ4qBrIUi', '张三', NULL, NULL, NULL, NULL, 'user', 'active'),
('13900139000', '$2b$12$Mq9a.Kr7A/GbTpFc6evrZuik5Uy.jPZ3nKfn08as1NDWpJ4qBrIUi', '李四', NULL, NULL, NULL, NULL, 'user', 'active');
