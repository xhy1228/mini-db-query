...
def main():
    ...
    try:
        ...
        # 注册路由
        from api import auth, query, logs, manage, stats, security, categories, fields, permissions, bindings, database_analysis
        ...
        app.include_router(bindings.router, prefix="/api")  # v1.2.0 学校-模板绑定
        app.include_router(database_analysis.router, prefix="/api")  # v1.2.0 数据库分析
